...
def main(form, filepath) -> None:
    ...
    try:
        ...
        form.inplace_change(os.path.join(final_export_path, "index.html"), "file:///" + filepath.replace(" ", "%20").replace(",", "%2C").replace("[", "%5B").replace("]", "%5D"), "https://ashsgrafiction.com/comics/" + comicTitle)

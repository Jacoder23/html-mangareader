...
class LueWidget(ttk.Frame):  
    def __init__(self, master=None, **kw):
        ...
        self.v_orientation.configure(text='Vertical', variable=orient, value=1)
        self.v_orientation.grid(column='0', row='7')
        self.h_orientation = ttk.Radiobutton(self)
        self.h_orientation.configure(text='Horizontal', variable=orient, value=2)
        ...
        self.l_bg.configure(text='Light', variable=color, value=1)
        self.l_bg.grid(column='0', row='10')
        self.d_bg = ttk.Radiobutton(self)
        self.d_bg.configure(text='Dark', variable=color, value=2)
...
def submit(self):
    main(self.html_entry.cget('path'))
